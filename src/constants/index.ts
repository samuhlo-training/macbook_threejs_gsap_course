/**
 * [RESOURCE] :: CONSTANTS_AND_DATA
 * ----------------------------------------------------------------------
 * Single Source of Truth (SSoT) for static data.
 *
 * TUTORIAL MODE:
 * Storing text, links, and configuration data in a separate file keeps
 * components clean and makes content updates much easier.
 *
...
const features = [
  {
    ...
    styles: "left-5 md:left-20 top-[30%] opacity-0 translate-y-5",
  },
  {
    id: 2,
