 ...
 *
 * TUTORIAL MODE:
 * This store acts as a "Global Brain" for the 3D model.
 * Any component (Size buttons, Color picker) can talk to this store,
 * and the 3D model listens to it to update itself.
 *
 * Responsibilities:
